...
package com.museumguild.ls.widgets.map.config;
...
import com.museumguild.ls.widgets.map.utils.MapCalibrationData;
...
public class MapConfigParser 
{
	...
	private static final String TAG = "MapConfigParser";
	...
	{
		InputStream is = null;
		com.museumguild.utils.Log.m(TAG,"parse:"+configPath);
		try {
